...
.tags-view-container {
  height: 42px;
  width: 100%;
  background: linear-gradient(180deg, rgba(255, 255, 255, .92), rgba(247, 244, 236, .9));
  border-bottom: 1px solid rgba(217, 227, 218, .8);
  display: flex;
  align-items: center;
  backdrop-filter: blur(16px);
  box-shadow: 0 8px 24px rgba(15, 32, 25, .05);
  position: relative;
  z-index: 8;

  $btn-width: 34px;
  $btn-color: #6b7a73;
  $btn-hover-bg: rgba(47, 125, 83, .08);
  $btn-hover-color: #1f5f3e;
  $btn-disabled-color: #c0c4cc;
  $divider: 1px solid rgba(217, 227, 218, .8);
  ...
  .tags-view-wrapper {
    ...
    .tags-view-item {
      ...
      height: 30px;
      line-height: 30px;
      border: 1px solid rgba(217, 227, 218, .92);
      color: #4a5a52;
      ...
      margin-left: 8px;
      border-radius: 999px;
      box-shadow: 0 4px 12px rgba(18, 43, 36, .04);
      ...
      &.active {
        background: linear-gradient(135deg, #2f7d53 0%, #1f5f3e 100%);
        color: #fff;
        border-color: transparent;
        box-shadow: 0 10px 20px rgba(47, 125, 83, .24);
      }

      &:hover:not(.active) {
        transform: translateY(-1px);
        background: rgba(47, 125, 83, .08);
      }
    }
  }
  ...
  .contextmenu {
    ...
    font-weight: 400;
    color: #24362f;
    border: 1px solid rgba(217, 227, 218, .88);
    box-shadow: 0 16px 30px rgba(18, 43, 36, .12);
