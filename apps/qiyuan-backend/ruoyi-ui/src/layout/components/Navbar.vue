...
.navbar {
  ...
  overflow: hidden;
  position: relative;
  background: linear-gradient(180deg, rgba(255, 255, 255, .94), rgba(247, 244, 236, .92));
  box-shadow: 0 10px 30px rgba(15, 32, 25, .08);
  border-bottom: 1px solid rgba(217, 227, 218, .72);
  display: flex;
  align-items: center;
  // padding: 0 8px;
    ...
    .avatar-container {
      ...
      .avatar-wrapper {
        ...
        .user-avatar {
          ...
          height: 30px;
          border-radius: 50%;
          border: 2px solid rgba(47, 125, 83, .14);
        }
